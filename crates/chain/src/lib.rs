...
impl Chain {
    ...
    pub fn default_amount_to_estimate_native_prices_with(&self) -> U256 {
        match &self {
            ...
            | Self::HyperEvm => 10u128.pow(17).into(), // 0.1 native token
    ...
    pub fn block_time_in_ms(&self) -> Duration {
        match self {
            ...
            Self::HyperEvm => Duration::from_millis(1_000), // 1 second block time
        }
    }
...
impl TryFrom<u64> for Chain {
    ...
    fn try_from(value: u64) -> Result<Self, Self::Error> {
        let network = match value {
            ...
            x if x == Self::HyperEvm as u64 => Self::HyperEvm,
